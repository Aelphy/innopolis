...
\begin{document}
	...
	\chapter{Bipedal Locomotion Control}
		...
		\section{Optimal Control}
			...
			We define G, the  transfer function associated with model defined be eq. (\ref{eq:oc1}). G is defined as in eq. \ref{eq:oc2}
			...
			$H_2$ norm of the transfer function is a gain in power from input to output, assuming that the input signal is white noise \cite{hazell2008discrete}.
